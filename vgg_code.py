...
his = model.fit_generator(train, steps_per_epoch = 50, epochs = 50, verbose = 1, callbacks = cb, validation_data = val, validation_steps = 50)
"""

his = model.fit_generator(train, steps_per_epoch = 30, verbose = 1, validation_data = val, validation_steps = 30)
